...
const page = async () => {
  ...
  return (
    <div className='flex flex-col gap-6 p-8 '>
      <h1  className='text-2xl font-semibold'>Congratulations, your application now has users!</h1>
      ...
      <div >
        ...
        <div style={{boxShadow:"rgba(0, 0, 0, 0.04) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px"}} className='border-[1px]  rounded-2xl w-fit p-6 pr-14 cursor-pointer'>
          <p className=' font-semibold mb-1'>Total users</p>
          <p className='text-gray-500 text-sm font-medium mb-2'>All time</p>
