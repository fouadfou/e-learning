...
const DashboardSidebar = ({listElements , userShow , role}) => {
  ...
  return (
    <div  style={{boxShadow:"rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.06) 0px 1px 2px 0px"}} className={`sticky ${role ? "top-[3.2rem] w-[11rem]":"top-0 w-[13rem]"} h-screen p-4 pt-1  flex flex-col gap-4 `}>
